...
namespace GeneXus.Programs {
   public class viewentrada : GXDataArea
   {
      public viewentrada( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EntradaId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
      ...
      protected void WB060( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Entradas", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEntrada.htm");
            ...
            GxWebStd.gx_label_element( context, edtPaisCompraNombre_Internalname, "Compra Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisCompraNombre_Internalname, StringUtil.RTrim( A27PaisCompraNombre), StringUtil.RTrim( context.localUtil.Format( A27PaisCompraNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisCompraNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPaisCompraNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewEntrada.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF062( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A12PaisCompraId = H00062_A12PaisCompraId[0];
               A11EntradaId = H00062_A11EntradaId[0];
               A27PaisCompraNombre = H00062_A27PaisCompraNombre[0];
      ...
      protected void STRUP060( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EntradaId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vENTRADAID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E11062( )
      {
         ...
         {
            A12PaisCompraId = H00063_A12PaisCompraId[0];
            A11EntradaId = H00063_A11EntradaId[0];
            A27PaisCompraNombre = H00063_A27PaisCompraNombre[0];
            AssignAttri("", false, "A27PaisCompraNombre", A27PaisCompraNombre);
            A27PaisCompraNombre = H00063_A27PaisCompraNombre[0];
            AssignAttri("", false, "A27PaisCompraNombre", A27PaisCompraNombre);
            AV16GXLvl7 = 1;
            Form.Caption = A27PaisCompraNombre;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12EntradaId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412445", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewentrada.js", "?2023874412445", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EntradaId',fld:'vENTRADAID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00062_A12PaisCompraId = new short[1] ;
         H00062_A11EntradaId = new short[1] ;
         H00062_A27PaisCompraNombre = new string[] {""} ;
         H00063_A12PaisCompraId = new short[1] ;
         H00063_A11EntradaId = new short[1] ;
         H00063_A27PaisCompraNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewentrada__default(),
            new Object[][] {
                new Object[] {
               H00062_A12PaisCompraId, H00062_A11EntradaId, H00062_A27PaisCompraNombre
               }
               , new Object[] {
               H00063_A12PaisCompraId, H00063_A11EntradaId, H00063_A27PaisCompraNombre
               }
            }
         );
      ...
      private short[] H00062_A12PaisCompraId ;
      private short[] H00062_A11EntradaId ;
      private string[] H00062_A27PaisCompraNombre ;
      private short[] H00063_A12PaisCompraId ;
      private short[] H00063_A11EntradaId ;
      private string[] H00063_A27PaisCompraNombre ;
   ...
   public class viewentrada__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00062", "SELECT T1.[PaisCompraId] AS PaisCompraId, T1.[EntradaId], T2.[PaisNombre] AS PaisCompraNombre FROM ([Entrada] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisCompraId]) WHERE T1.[EntradaId] = @AV12EntradaId ORDER BY T1.[EntradaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00062,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00063", "SELECT T1.[PaisCompraId] AS PaisCompraId, T1.[EntradaId], T2.[PaisNombre] AS PaisCompraNombre FROM ([Entrada] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisCompraId]) WHERE T1.[EntradaId] = @AV12EntradaId ORDER BY T1.[EntradaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00063,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
