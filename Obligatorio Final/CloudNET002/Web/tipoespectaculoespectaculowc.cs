...
namespace GeneXus.Programs {
   public class tipoespectaculoespectaculowc : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               AssignProp(sPrefix, false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_24_Refreshing);
               edtavDelete_Enabled = 0;
               AssignProp(sPrefix, false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_24_Refreshing);
               WS0N2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"PAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ",", "")));
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Espectáculo", "", "", lblTitletext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_TipoEspectaculoEspectaculoWC.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TipoEspectaculoEspectaculoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A6TipoEspectaculoId), 4, 0, ",", "")), StringUtil.LTrim( ((edtTipoEspectaculoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A6TipoEspectaculoId), "ZZZ9") : context.localUtil.Format( (decimal)(A6TipoEspectaculoId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoId_Jsonclick, 0, "Attribute", "", "", "", "", edtTipoEspectaculoId_Visible, edtTipoEspectaculoId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_TipoEspectaculoEspectaculoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_24_Refreshing);
                              AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ESPECTACULOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A5EspectaculoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESPECTACULOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5EspectaculoId), 4, 0, ".", "")));
      }
      ...
      protected void RF0N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1PaisId = H000N2_A1PaisId[0];
               A6TipoEspectaculoId = H000N2_A6TipoEspectaculoId[0];
               AssignAttri(sPrefix, false, "A6TipoEspectaculoId", StringUtil.LTrimStr( (decimal)(A6TipoEspectaculoId), 4, 0));
               A36CantidadProductos = H000N2_A36CantidadProductos[0];
               A29CantidadSectores = H000N2_A29CantidadSectores[0];
               A40000EspectaculoAfiche_GXI = H000N2_A40000EspectaculoAfiche_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_24_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A28PaisOrigenNombre = H000N2_A28PaisOrigenNombre[0];
               A7PaisOrigenId = H000N2_A7PaisOrigenId[0];
               A2PaisNombre = H000N2_A2PaisNombre[0];
               A4LugarNombre = H000N2_A4LugarNombre[0];
               A3LugarId = H000N2_A3LugarId[0];
               A19EspectaculoFecha = H000N2_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000N2_A8EspectaculoNombre[0];
               A5EspectaculoId = H000N2_A5EspectaculoId[0];
               A33EspectaculoInvitacionesEntrega = H000N2_A33EspectaculoInvitacionesEntrega[0];
               A31EspectaculoCantidadInvitacione = H000N2_A31EspectaculoCantidadInvitacione[0];
               A20EspectaculoAfiche = H000N2_A20EspectaculoAfiche[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_24_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A28PaisOrigenNombre = H000N2_A28PaisOrigenNombre[0];
               A1PaisId = H000N2_A1PaisId[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ESPECTACULOID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sPrefix+sGXsfl_24_idx, context.localUtil.Format( (decimal)(A5EspectaculoId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202387447947", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tipoespectaculoespectaculowc.js", "?202387447947", false, true);
         }
      ...
      {
         edtEspectaculoId_Internalname = sPrefix+"ESPECTACULOID_"+sGXsfl_24_idx;
         edtEspectaculoNombre_Internalname = sPrefix+"ESPECTACULONOMBRE_"+sGXsfl_24_idx;
         edtEspectaculoFecha_Internalname = sPrefix+"ESPECTACULOFECHA_"+sGXsfl_24_idx;
         edtLugarId_Internalname = sPrefix+"LUGARID_"+sGXsfl_24_idx;
         edtLugarNombre_Internalname = sPrefix+"LUGARNOMBRE_"+sGXsfl_24_idx;
         edtPaisNombre_Internalname = sPrefix+"PAISNOMBRE_"+sGXsfl_24_idx;
         edtPaisOrigenId_Internalname = sPrefix+"PAISORIGENID_"+sGXsfl_24_idx;
         edtPaisOrigenNombre_Internalname = sPrefix+"PAISORIGENNOMBRE_"+sGXsfl_24_idx;
         edtEspectaculoAfiche_Internalname = sPrefix+"ESPECTACULOAFICHE_"+sGXsfl_24_idx;
         edtEspectaculoCantidadInvitacione_Internalname = sPrefix+"ESPECTACULOCANTIDADINVITACIONE_"+sGXsfl_24_idx;
         edtEspectaculoInvitacionesDisponi_Internalname = sPrefix+"ESPECTACULOINVITACIONESDISPONI_"+sGXsfl_24_idx;
         edtCantidadSectores_Internalname = sPrefix+"CANTIDADSECTORES_"+sGXsfl_24_idx;
         edtEspectaculoInvitacionesEntrega_Internalname = sPrefix+"ESPECTACULOINVITACIONESENTREGA_"+sGXsfl_24_idx;
         edtCantidadProductos_Internalname = sPrefix+"CANTIDADPRODUCTOS_"+sGXsfl_24_idx;
         edtavUpdate_Internalname = sPrefix+"vUPDATE_"+sGXsfl_24_idx;
         edtavDelete_Internalname = sPrefix+"vDELETE_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtEspectaculoId_Internalname = sPrefix+"ESPECTACULOID_"+sGXsfl_24_fel_idx;
         edtEspectaculoNombre_Internalname = sPrefix+"ESPECTACULONOMBRE_"+sGXsfl_24_fel_idx;
         edtEspectaculoFecha_Internalname = sPrefix+"ESPECTACULOFECHA_"+sGXsfl_24_fel_idx;
         edtLugarId_Internalname = sPrefix+"LUGARID_"+sGXsfl_24_fel_idx;
         edtLugarNombre_Internalname = sPrefix+"LUGARNOMBRE_"+sGXsfl_24_fel_idx;
         edtPaisNombre_Internalname = sPrefix+"PAISNOMBRE_"+sGXsfl_24_fel_idx;
         edtPaisOrigenId_Internalname = sPrefix+"PAISORIGENID_"+sGXsfl_24_fel_idx;
         edtPaisOrigenNombre_Internalname = sPrefix+"PAISORIGENNOMBRE_"+sGXsfl_24_fel_idx;
         edtEspectaculoAfiche_Internalname = sPrefix+"ESPECTACULOAFICHE_"+sGXsfl_24_fel_idx;
         edtEspectaculoCantidadInvitacione_Internalname = sPrefix+"ESPECTACULOCANTIDADINVITACIONE_"+sGXsfl_24_fel_idx;
         edtEspectaculoInvitacionesDisponi_Internalname = sPrefix+"ESPECTACULOINVITACIONESDISPONI_"+sGXsfl_24_fel_idx;
         edtCantidadSectores_Internalname = sPrefix+"CANTIDADSECTORES_"+sGXsfl_24_fel_idx;
         edtEspectaculoInvitacionesEntrega_Internalname = sPrefix+"ESPECTACULOINVITACIONESENTREGA_"+sGXsfl_24_fel_idx;
         edtCantidadProductos_Internalname = sPrefix+"CANTIDADPRODUCTOS_"+sGXsfl_24_fel_idx;
         edtavUpdate_Internalname = sPrefix+"vUPDATE_"+sGXsfl_24_fel_idx;
         edtavDelete_Internalname = sPrefix+"vDELETE_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisOrigenId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7PaisOrigenId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A7PaisOrigenId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisOrigenId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)24,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEspectaculoInvitacionesDisponi_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A32EspectaculoInvitacionesDisponi), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A32EspectaculoInvitacionesDisponi), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEspectaculoInvitacionesDisponi_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)24,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEspectaculoInvitacionesEntrega_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A33EspectaculoInvitacionesEntrega), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A33EspectaculoInvitacionesEntrega), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEspectaculoInvitacionesEntrega_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)24,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCantidadProductos_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A36CantidadProductos), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A36CantidadProductos), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCantidadProductos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)24,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl24( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Origen Nombre") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ImageAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Afiche") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Cantidad Invitaciones") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Invitaciones Disponibles") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Sectores") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Invitaciones Entregadas") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A36CantidadProductos), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtEspectaculoAfiche_Internalname = sPrefix+"ESPECTACULOAFICHE";
         ...
         edtCantidadProductos_Internalname = sPrefix+"CANTIDADPRODUCTOS";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130N2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9'},{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEspectaculoNombre_Link',ctrl:'ESPECTACULONOMBRE',prop:'Link'},{av:'edtLugarNombre_Link',ctrl:'LUGARNOMBRE',prop:'Link'},{av:'edtPaisNombre_Link',ctrl:'PAISNOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110N2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000N2_A1PaisId = new short[1] ;
         H000N2_A6TipoEspectaculoId = new short[1] ;
         H000N2_A36CantidadProductos = new short[1] ;
         H000N2_A29CantidadSectores = new short[1] ;
         H000N2_A40000EspectaculoAfiche_GXI = new string[] {""} ;
         H000N2_A28PaisOrigenNombre = new string[] {""} ;
         H000N2_A7PaisOrigenId = new short[1] ;
         H000N2_A2PaisNombre = new string[] {""} ;
         H000N2_A4LugarNombre = new string[] {""} ;
         H000N2_A3LugarId = new short[1] ;
         H000N2_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000N2_A8EspectaculoNombre = new string[] {""} ;
         H000N2_A5EspectaculoId = new short[1] ;
         H000N2_A33EspectaculoInvitacionesEntrega = new short[1] ;
         H000N2_A31EspectaculoCantidadInvitacione = new short[1] ;
         H000N2_A20EspectaculoAfiche = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipoespectaculoespectaculowc__default(),
            new Object[][] {
                new Object[] {
               H000N2_A1PaisId, H000N2_A6TipoEspectaculoId, H000N2_A36CantidadProductos, H000N2_A29CantidadSectores, H000N2_A40000EspectaculoAfiche_GXI, H000N2_A28PaisOrigenNombre, H000N2_A7PaisOrigenId, H000N2_A2PaisNombre, H000N2_A4LugarNombre, H000N2_A3LugarId,
               H000N2_A19EspectaculoFecha, H000N2_A8EspectaculoNombre, H000N2_A5EspectaculoId, H000N2_A33EspectaculoInvitacionesEntrega, H000N2_A31EspectaculoCantidadInvitacione, H000N2_A20EspectaculoAfiche
               }
               , new Object[] {
      ...
      private short[] H000N2_A1PaisId ;
      private short[] H000N2_A6TipoEspectaculoId ;
      private short[] H000N2_A36CantidadProductos ;
      private short[] H000N2_A29CantidadSectores ;
      private string[] H000N2_A40000EspectaculoAfiche_GXI ;
      private string[] H000N2_A28PaisOrigenNombre ;
      private short[] H000N2_A7PaisOrigenId ;
      private string[] H000N2_A2PaisNombre ;
      private string[] H000N2_A4LugarNombre ;
      private short[] H000N2_A3LugarId ;
      private DateTime[] H000N2_A19EspectaculoFecha ;
      private string[] H000N2_A8EspectaculoNombre ;
      private short[] H000N2_A5EspectaculoId ;
      private short[] H000N2_A33EspectaculoInvitacionesEntrega ;
      private short[] H000N2_A31EspectaculoCantidadInvitacione ;
      private string[] H000N2_A20EspectaculoAfiche ;
   ...
   public class tipoespectaculoespectaculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000N2", "SELECT T3.[PaisId], T1.[TipoEspectaculoId], T1.[CantidadProductos], T1.[CantidadSectores], T1.[EspectaculoAfiche_GXI], T2.[PaisNombre] AS PaisOrigenNombre, T1.[PaisOrigenId] AS PaisOrigenId, T4.[PaisNombre], T3.[LugarNombre], T1.[LugarId], T1.[EspectaculoFecha], T1.[EspectaculoNombre], T1.[EspectaculoId], T1.[EspectaculoInvitacionesEntrega], T1.[EspectaculoCantidadInvitacione], T1.[EspectaculoAfiche] FROM ((([Espectaculo] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisOrigenId]) INNER JOIN [Lugar] T3 ON T3.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T4 ON T4.[PaisId] = T3.[PaisId]) WHERE T1.[TipoEspectaculoId] = @AV6TipoEspectaculoId ORDER BY T1.[TipoEspectaculoId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000N3", "SELECT COUNT(*) FROM ((([Espectaculo] T1 INNER JOIN [Pais] T4 ON T4.[PaisId] = T1.[PaisOrigenId]) INNER JOIN [Lugar] T2 ON T2.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId]) WHERE T1.[TipoEspectaculoId] = @AV6TipoEspectaculoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000N3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
