   ...
   public class wwpais : GXDataArea
   {
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Países", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPais.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A43PaisBandera = cgiGet( edtPaisBandera_Internalname);
                              n43PaisBandera = false;
                              AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_24_Refreshing);
                              AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         edtavDelete_Enabled = 0;
         AssignProp("", false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_24_Refreshing);
      }
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A40000PaisBandera_GXI = H00052_A40000PaisBandera_GXI[0];
               n40000PaisBandera_GXI = H00052_n40000PaisBandera_GXI[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               A1PaisId = H00052_A1PaisId[0];
               A43PaisBandera = H00052_A43PaisBandera[0];
               n43PaisBandera = H00052_n43PaisBandera[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_24_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               E14052 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9"), context));
      }
      ...
      private void E14052( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A1PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         edtavDelete_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A1PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 24;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412560", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpais.js", "?2023874412561", false, true);
         }
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_24_idx;
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_24_idx;
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_24_fel_idx;
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_24_fel_idx;
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A43PaisBandera));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14052',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11052',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H00052_A40000PaisBandera_GXI = new string[] {""} ;
         H00052_n40000PaisBandera_GXI = new bool[] {false} ;
         H00052_A1PaisId = new short[1] ;
         H00052_A43PaisBandera = new string[] {""} ;
         H00052_n43PaisBandera = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpais__default(),
            new Object[][] {
                new Object[] {
               H00052_A2PaisNombre, H00052_A40000PaisBandera_GXI, H00052_n40000PaisBandera_GXI, H00052_A1PaisId, H00052_A43PaisBandera, H00052_n43PaisBandera
               }
               , new Object[] {
      ...
      private string[] H00052_A40000PaisBandera_GXI ;
      private bool[] H00052_n40000PaisBandera_GXI ;
      private short[] H00052_A1PaisId ;
      private string[] H00052_A43PaisBandera ;
      private bool[] H00052_n43PaisBandera ;
   ...
   public class wwpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00052", "SELECT [PaisNombre], [PaisBandera_GXI], [PaisId], [PaisBandera] FROM [Pais] ORDER BY [PaisId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00052,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00053", "SELECT COUNT(*) FROM [Pais] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00053,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
