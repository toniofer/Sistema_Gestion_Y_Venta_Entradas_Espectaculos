...
namespace GeneXus.Programs {
   public class lugarespectaculowc : GXWebComponent
   {
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_LugarEspectaculoWC.htm");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_22_Refreshing);
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A3LugarId = H000P2_A3LugarId[0];
               AssignAttri(sPrefix, false, "A3LugarId", StringUtil.LTrimStr( (decimal)(A3LugarId), 4, 0));
               A36CantidadProductos = H000P2_A36CantidadProductos[0];
               A29CantidadSectores = H000P2_A29CantidadSectores[0];
               A40000EspectaculoAfiche_GXI = H000P2_A40000EspectaculoAfiche_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A28PaisOrigenNombre = H000P2_A28PaisOrigenNombre[0];
               A7PaisOrigenId = H000P2_A7PaisOrigenId[0];
               A16TipoEspectaculoNombre = H000P2_A16TipoEspectaculoNombre[0];
               A6TipoEspectaculoId = H000P2_A6TipoEspectaculoId[0];
               A19EspectaculoFecha = H000P2_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000P2_A8EspectaculoNombre[0];
               A5EspectaculoId = H000P2_A5EspectaculoId[0];
               A33EspectaculoInvitacionesEntrega = H000P2_A33EspectaculoInvitacionesEntrega[0];
               A31EspectaculoCantidadInvitacione = H000P2_A31EspectaculoCantidadInvitacione[0];
               A20EspectaculoAfiche = H000P2_A20EspectaculoAfiche[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A28PaisOrigenNombre = H000P2_A28PaisOrigenNombre[0];
               A16TipoEspectaculoNombre = H000P2_A16TipoEspectaculoNombre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ESPECTACULOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A5EspectaculoId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412350", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("lugarespectaculowc.js", "?2023874412350", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtTipoEspectaculoId_Internalname = sPrefix+"TIPOESPECTACULOID_"+sGXsfl_22_idx;
         edtTipoEspectaculoNombre_Internalname = sPrefix+"TIPOESPECTACULONOMBRE_"+sGXsfl_22_idx;
         edtPaisOrigenId_Internalname = sPrefix+"PAISORIGENID_"+sGXsfl_22_idx;
         edtPaisOrigenNombre_Internalname = sPrefix+"PAISORIGENNOMBRE_"+sGXsfl_22_idx;
         edtEspectaculoAfiche_Internalname = sPrefix+"ESPECTACULOAFICHE_"+sGXsfl_22_idx;
         edtCantidadSectores_Internalname = sPrefix+"CANTIDADSECTORES_"+sGXsfl_22_idx;
         edtEspectaculoCantidadInvitacione_Internalname = sPrefix+"ESPECTACULOCANTIDADINVITACIONE_"+sGXsfl_22_idx;
         edtEspectaculoInvitacionesDisponi_Internalname = sPrefix+"ESPECTACULOINVITACIONESDISPONI_"+sGXsfl_22_idx;
         edtEspectaculoInvitacionesEntrega_Internalname = sPrefix+"ESPECTACULOINVITACIONESENTREGA_"+sGXsfl_22_idx;
         edtCantidadProductos_Internalname = sPrefix+"CANTIDADPRODUCTOS_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtTipoEspectaculoId_Internalname = sPrefix+"TIPOESPECTACULOID_"+sGXsfl_22_fel_idx;
         edtTipoEspectaculoNombre_Internalname = sPrefix+"TIPOESPECTACULONOMBRE_"+sGXsfl_22_fel_idx;
         edtPaisOrigenId_Internalname = sPrefix+"PAISORIGENID_"+sGXsfl_22_fel_idx;
         edtPaisOrigenNombre_Internalname = sPrefix+"PAISORIGENNOMBRE_"+sGXsfl_22_fel_idx;
         edtEspectaculoAfiche_Internalname = sPrefix+"ESPECTACULOAFICHE_"+sGXsfl_22_fel_idx;
         edtCantidadSectores_Internalname = sPrefix+"CANTIDADSECTORES_"+sGXsfl_22_fel_idx;
         edtEspectaculoCantidadInvitacione_Internalname = sPrefix+"ESPECTACULOCANTIDADINVITACIONE_"+sGXsfl_22_fel_idx;
         edtEspectaculoInvitacionesDisponi_Internalname = sPrefix+"ESPECTACULOINVITACIONESDISPONI_"+sGXsfl_22_fel_idx;
         edtEspectaculoInvitacionesEntrega_Internalname = sPrefix+"ESPECTACULOINVITACIONESENTREGA_"+sGXsfl_22_fel_idx;
         edtCantidadProductos_Internalname = sPrefix+"CANTIDADPRODUCTOS_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTipoEspectaculoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6TipoEspectaculoId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A6TipoEspectaculoId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTipoEspectaculoId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTipoEspectaculoNombre_Internalname,StringUtil.RTrim( A16TipoEspectaculoNombre),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtTipoEspectaculoNombre_Link,(string)"",(string)"",(string)"",(string)edtTipoEspectaculoNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130P2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110P2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000P2_A3LugarId = new short[1] ;
         H000P2_A36CantidadProductos = new short[1] ;
         H000P2_A29CantidadSectores = new short[1] ;
         H000P2_A40000EspectaculoAfiche_GXI = new string[] {""} ;
         H000P2_A28PaisOrigenNombre = new string[] {""} ;
         H000P2_A7PaisOrigenId = new short[1] ;
         H000P2_A16TipoEspectaculoNombre = new string[] {""} ;
         H000P2_A6TipoEspectaculoId = new short[1] ;
         H000P2_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000P2_A8EspectaculoNombre = new string[] {""} ;
         H000P2_A5EspectaculoId = new short[1] ;
         H000P2_A33EspectaculoInvitacionesEntrega = new short[1] ;
         H000P2_A31EspectaculoCantidadInvitacione = new short[1] ;
         H000P2_A20EspectaculoAfiche = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.lugarespectaculowc__default(),
            new Object[][] {
                new Object[] {
               H000P2_A3LugarId, H000P2_A36CantidadProductos, H000P2_A29CantidadSectores, H000P2_A40000EspectaculoAfiche_GXI, H000P2_A28PaisOrigenNombre, H000P2_A7PaisOrigenId, H000P2_A16TipoEspectaculoNombre, H000P2_A6TipoEspectaculoId, H000P2_A19EspectaculoFecha, H000P2_A8EspectaculoNombre,
               H000P2_A5EspectaculoId, H000P2_A33EspectaculoInvitacionesEntrega, H000P2_A31EspectaculoCantidadInvitacione, H000P2_A20EspectaculoAfiche
               }
               , new Object[] {
      ...
      private short[] H000P2_A3LugarId ;
      private short[] H000P2_A36CantidadProductos ;
      private short[] H000P2_A29CantidadSectores ;
      private string[] H000P2_A40000EspectaculoAfiche_GXI ;
      private string[] H000P2_A28PaisOrigenNombre ;
      private short[] H000P2_A7PaisOrigenId ;
      private string[] H000P2_A16TipoEspectaculoNombre ;
      private short[] H000P2_A6TipoEspectaculoId ;
      private DateTime[] H000P2_A19EspectaculoFecha ;
      private string[] H000P2_A8EspectaculoNombre ;
      private short[] H000P2_A5EspectaculoId ;
      private short[] H000P2_A33EspectaculoInvitacionesEntrega ;
      private short[] H000P2_A31EspectaculoCantidadInvitacione ;
      private string[] H000P2_A20EspectaculoAfiche ;
   ...
   public class lugarespectaculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000P2", "SELECT T1.[LugarId], T1.[CantidadProductos], T1.[CantidadSectores], T1.[EspectaculoAfiche_GXI], T2.[PaisNombre] AS PaisOrigenNombre, T1.[PaisOrigenId] AS PaisOrigenId, T3.[TipoEspectaculoNombre], T1.[TipoEspectaculoId], T1.[EspectaculoFecha], T1.[EspectaculoNombre], T1.[EspectaculoId], T1.[EspectaculoInvitacionesEntrega], T1.[EspectaculoCantidadInvitacione], T1.[EspectaculoAfiche] FROM (([Espectaculo] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisOrigenId]) INNER JOIN [TipoEspectaculo] T3 ON T3.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[LugarId] = @AV6LugarId ORDER BY T1.[LugarId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000P3", "SELECT COUNT(*) FROM (([Espectaculo] T1 INNER JOIN [Pais] T3 ON T3.[PaisId] = T1.[PaisOrigenId]) INNER JOIN [TipoEspectaculo] T2 ON T2.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[LugarId] = @AV6LugarId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000P3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
