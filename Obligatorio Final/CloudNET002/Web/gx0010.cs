...
namespace GeneXus.Programs {
   public class gx0010 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pPaisId,4,0))}, new string[] {"pPaisId"}) +"\">") ;
      ...
      {
         return formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pPaisId,4,0))}, new string[] {"pPaisId"})  ;
      }
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisidfilter_Internalname, "Pais Id", "", "", lblLblpaisidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11121_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisnombrefilter_Internalname, "Pais Nombre", "", "", lblLblpaisnombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12121_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e13121_client"+"'", TempTags, "", 2, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_34_Refreshing);
      ...
      protected void RF122( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cPaisNombre = StringUtil.PadR( StringUtil.RTrim( AV7cPaisNombre), 60, "%");
            /* Using cursor H00122 */
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               ...
               n40000PaisBandera_GXI = H00122_n40000PaisBandera_GXI[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               A2PaisNombre = H00122_A2PaisNombre[0];
               A1PaisId = H00122_A1PaisId[0];
               A43PaisBandera = H00122_A43PaisBandera[0];
               n43PaisBandera = H00122_n43PaisBandera[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               /* Execute user event: Load */
               E15122 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412971", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?2023874412971", false, true);
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisBandera_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A43PaisBandera_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A43PaisBandera));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLPAISIDFILTER.CLICK","{handler:'E11121',iparms:[{av:'divPaisidfiltercontainer_Class',ctrl:'PAISIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPAISNOMBREFILTER.CLICK","{handler:'E12121',iparms:[{av:'divPaisnombrefiltercontainer_Class',ctrl:'PAISNOMBREFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E16122',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H00122_n40000PaisBandera_GXI = new bool[] {false} ;
         H00122_A2PaisNombre = new string[] {""} ;
         H00122_A1PaisId = new short[1] ;
         H00122_A43PaisBandera = new string[] {""} ;
         H00122_n43PaisBandera = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00122_A40000PaisBandera_GXI, H00122_n40000PaisBandera_GXI, H00122_A2PaisNombre, H00122_A1PaisId, H00122_A43PaisBandera, H00122_n43PaisBandera
               }
               , new Object[] {
      ...
      private bool[] H00122_n40000PaisBandera_GXI ;
      private string[] H00122_A2PaisNombre ;
      private short[] H00122_A1PaisId ;
      private string[] H00122_A43PaisBandera ;
      private bool[] H00122_n43PaisBandera ;
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cPaisNombre",GXType.NChar,60,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00122", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00122,1, GxCacheFrequency.OFF ,false,false )
