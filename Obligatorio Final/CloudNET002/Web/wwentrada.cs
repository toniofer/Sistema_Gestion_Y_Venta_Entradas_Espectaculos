...
namespace GeneXus.Programs {
   public class wwentrada : GXDataArea
   {
      public wwentrada( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11PaisCompraNombre = GetPar( "PaisCompraNombre");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11PaisCompraNombre) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPAISCOMPRANOMBRE", StringUtil.RTrim( AV11PaisCompraNombre));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "SECTORENTRADASVENDIDAS", StringUtil.LTrim( StringUtil.NToC( (decimal)(A25SectorEntradasVendidas), 5, 0, ",", "")));
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Entradas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWEntrada.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEntrada.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavPaiscompranombre_Internalname, "Pais Compra Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPaiscompranombre_Internalname, StringUtil.RTrim( AV11PaisCompraNombre), StringUtil.RTrim( context.localUtil.Format( AV11PaisCompraNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Compra Nombre", edtavPaiscompranombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPaiscompranombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWEntrada.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0C2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Entrada", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Paiscompranombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPAISCOMPRANOMBRE"), AV11PaisCompraNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0C2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavPaiscompranombre_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ENTRADAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A11EntradaId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "ENTRADAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11EntradaId), 4, 0, ".", "")));
      }
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11PaisCompraNombre ,
                                                 A27PaisCompraNombre } ,
                                                 new int[]{
                                                 }
            });
            lV11PaisCompraNombre = StringUtil.PadR( StringUtil.RTrim( AV11PaisCompraNombre), 60, "%");
            /* Using cursor H000C3 */
            pr_default.execute(0, new Object[] {lV11PaisCompraNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A19EspectaculoFecha = H000C3_A19EspectaculoFecha[0];
               A27PaisCompraNombre = H000C3_A27PaisCompraNombre[0];
               A12PaisCompraId = H000C3_A12PaisCompraId[0];
               A23SectorPrecio = H000C3_A23SectorPrecio[0];
               A21SectorNombre = H000C3_A21SectorNombre[0];
               A9SectorId = H000C3_A9SectorId[0];
               n9SectorId = H000C3_n9SectorId[0];
               A8EspectaculoNombre = H000C3_A8EspectaculoNombre[0];
               A5EspectaculoId = H000C3_A5EspectaculoId[0];
               n5EspectaculoId = H000C3_n5EspectaculoId[0];
               A11EntradaId = H000C3_A11EntradaId[0];
               A25SectorEntradasVendidas = H000C3_A25SectorEntradasVendidas[0];
               n25SectorEntradasVendidas = H000C3_n25SectorEntradasVendidas[0];
               A22SectorCapacidad = H000C3_A22SectorCapacidad[0];
               A27PaisCompraNombre = H000C3_A27PaisCompraNombre[0];
               A19EspectaculoFecha = H000C3_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000C3_A8EspectaculoNombre[0];
               A23SectorPrecio = H000C3_A23SectorPrecio[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_ENTRADAID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A11EntradaId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11PaisCompraNombre = StringUtil.PadR( StringUtil.RTrim( AV11PaisCompraNombre), 60, "%");
         /* Using cursor H000C5 */
         pr_default.execute(1, new Object[] {lV11PaisCompraNombre});
         GRID_nRecordCount = H000C5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11PaisCompraNombre = GridState.FilterValues("Paiscompranombre");
            AssignAttri("", false, "AV11PaisCompraNombre", AV11PaisCompraNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PaisCompraNombre", AV11PaisCompraNombre);
      }
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11PaisCompraNombre = cgiGet( edtavPaiscompranombre_Internalname);
            AssignAttri("", false, "AV11PaisCompraNombre", AV11PaisCompraNombre);
      ...
      private void E140C2( )
      {
         ...
         edtPaisCompraNombre_Link = formatLink("viewentrada.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A11EntradaId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"EntradaId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412499", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwentrada.js", "?202387441250", false, true);
         }
      ...
      {
         edtEntradaId_Internalname = "ENTRADAID_"+sGXsfl_27_idx;
         ...
         edtSectorPrecio_Internalname = "SECTORPRECIO_"+sGXsfl_27_idx;
         edtSectorEntradasDisponibles_Internalname = "SECTORENTRADASDISPONIBLES_"+sGXsfl_27_idx;
         edtPaisCompraId_Internalname = "PAISCOMPRAID_"+sGXsfl_27_idx;
         edtPaisCompraNombre_Internalname = "PAISCOMPRANOMBRE_"+sGXsfl_27_idx;
         edtEspectaculoFecha_Internalname = "ESPECTACULOFECHA_"+sGXsfl_27_idx;
      }

      protected void SubsflControlProps_fel_272( )
      {
         edtEntradaId_Internalname = "ENTRADAID_"+sGXsfl_27_fel_idx;
         ...
         edtSectorPrecio_Internalname = "SECTORPRECIO_"+sGXsfl_27_fel_idx;
         edtSectorEntradasDisponibles_Internalname = "SECTORENTRADASDISPONIBLES_"+sGXsfl_27_fel_idx;
         edtPaisCompraId_Internalname = "PAISCOMPRAID_"+sGXsfl_27_fel_idx;
         edtPaisCompraNombre_Internalname = "PAISCOMPRANOMBRE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEntradaId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A11EntradaId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A11EntradaId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEntradaId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9SectorId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9SectorId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorEntradasDisponibles_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A24SectorEntradasDisponibles), 5, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A24SectorEntradasDisponibles), "ZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorEntradasDisponibles_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)5,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisCompraId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12PaisCompraId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12PaisCompraId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisCompraId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisCompraNombre_Internalname,StringUtil.RTrim( A27PaisCompraNombre),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtPaisCompraNombre_Link,(string)"",(string)"",(string)"",(string)edtPaisCompraNombre_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "País de compra") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A12PaisCompraId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A27PaisCompraNombre)));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtPaisCompraNombre_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavPaiscompranombre_Internalname = "vPAISCOMPRANOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavPaiscompranombre_Jsonclick = "";
         edtavPaiscompranombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Work With Entrada";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisCompraNombre',fld:'vPAISCOMPRANOMBRE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140C2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'},{av:'A11EntradaId',fld:'ENTRADAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtEspectaculoNombre_Link',ctrl:'ESPECTACULONOMBRE',prop:'Link'},{av:'edtPaisCompraNombre_Link',ctrl:'PAISCOMPRANOMBRE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110C2',iparms:[{av:'A11EntradaId',fld:'ENTRADAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisCompraNombre',fld:'vPAISCOMPRANOMBRE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisCompraNombre',fld:'vPAISCOMPRANOMBRE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisCompraNombre',fld:'vPAISCOMPRANOMBRE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaisCompraNombre',fld:'vPAISCOMPRANOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11PaisCompraNombre = "";
         H000C3_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000C3_A27PaisCompraNombre = new string[] {""} ;
         H000C3_A12PaisCompraId = new short[1] ;
         H000C3_A23SectorPrecio = new int[1] ;
         H000C3_A21SectorNombre = new string[] {""} ;
         H000C3_A9SectorId = new short[1] ;
         H000C3_n9SectorId = new bool[] {false} ;
         H000C3_A8EspectaculoNombre = new string[] {""} ;
         H000C3_A5EspectaculoId = new short[1] ;
         H000C3_n5EspectaculoId = new bool[] {false} ;
         H000C3_A11EntradaId = new short[1] ;
         H000C3_A25SectorEntradasVendidas = new int[1] ;
         H000C3_n25SectorEntradasVendidas = new bool[] {false} ;
         H000C3_A22SectorCapacidad = new int[1] ;
         H000C5_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwentrada__default(),
            new Object[][] {
                new Object[] {
               H000C3_A19EspectaculoFecha, H000C3_A27PaisCompraNombre, H000C3_A12PaisCompraId, H000C3_A23SectorPrecio, H000C3_A21SectorNombre, H000C3_A9SectorId, H000C3_n9SectorId, H000C3_A8EspectaculoNombre, H000C3_A5EspectaculoId, H000C3_n5EspectaculoId,
               H000C3_A11EntradaId, H000C3_A25SectorEntradasVendidas, H000C3_n25SectorEntradasVendidas, H000C3_A22SectorCapacidad
               }
               , new Object[] {
               H000C5_AGRID_nRecordCount
               }
            }
         );
         AV15Pgmname = "WWEntrada";
      ...
      private int edtavPaiscompranombre_Enabled ;
      ...
      private string AV11PaisCompraNombre ;
      ...
      private string edtavPaiscompranombre_Internalname ;
      private string edtavPaiscompranombre_Jsonclick ;
      ...
      private string lV11PaisCompraNombre ;
      private string edtEspectaculoNombre_Link ;
      private string edtPaisCompraNombre_Link ;
      ...
      private DateTime[] H000C3_A19EspectaculoFecha ;
      private string[] H000C3_A27PaisCompraNombre ;
      private short[] H000C3_A12PaisCompraId ;
      private int[] H000C3_A23SectorPrecio ;
      private string[] H000C3_A21SectorNombre ;
      private short[] H000C3_A9SectorId ;
      private bool[] H000C3_n9SectorId ;
      private string[] H000C3_A8EspectaculoNombre ;
      private short[] H000C3_A5EspectaculoId ;
      private bool[] H000C3_n5EspectaculoId ;
      private short[] H000C3_A11EntradaId ;
      private int[] H000C3_A25SectorEntradasVendidas ;
      private bool[] H000C3_n25SectorEntradasVendidas ;
      private int[] H000C3_A22SectorCapacidad ;
      private long[] H000C5_AGRID_nRecordCount ;
   ...
   public class wwentrada__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A27PaisCompraNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[EspectaculoFecha], T2.[PaisNombre] AS PaisCompraNombre, T1.[PaisCompraId] AS PaisCompraId, T4.[SectorPrecio], T4.[SectorNombre], T1.[SectorId], T3.[EspectaculoNombre], T1.[EspectaculoId], T1.[EntradaId], COALESCE( T5.[SectorEntradasVendidas], 0) AS SectorEntradasVendidas, T4.[SectorCapacidad]";
         sFromString = " FROM (((([Entrada] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisCompraId]) INNER JOIN [Espectaculo] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [EspectaculoSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[SectorId] = T1.[SectorId]) LEFT JOIN (SELECT COUNT(*) AS SectorEntradasVendidas, [EspectaculoId], [SectorId] FROM [Entrada] GROUP BY [EspectaculoId], [SectorId] ) T5 ON T5.[EspectaculoId] = T1.[EspectaculoId] AND T5.[SectorId] = T1.[SectorId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11PaisCompraNombre)) )
         {
            AddWhere(sWhereString, "(T2.[PaisNombre] like @lV11PaisCompraNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T2.[PaisNombre]";
      ...
      protected Object[] conditional_H000C5( IGxContext context ,
                                             string AV11PaisCompraNombre ,
                                             string A27PaisCompraNombre )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         ...
         scmdbuf = "SELECT COUNT(*) FROM (((([Entrada] T1 INNER JOIN [Pais] T4 ON T4.[PaisId] = T1.[PaisCompraId]) INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) INNER JOIN [EspectaculoSector] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId] AND T3.[SectorId] = T1.[SectorId]) LEFT JOIN (SELECT COUNT(*) AS SectorEntradasVendidas, [EspectaculoId], [SectorId] FROM [Entrada] GROUP BY [EspectaculoId], [SectorId] ) T5 ON T5.[EspectaculoId] = T1.[EspectaculoId] AND T5.[SectorId] = T1.[SectorId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11PaisCompraNombre)) )
         {
            AddWhere(sWhereString, "(T4.[PaisNombre] like @lV11PaisCompraNombre)");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 1 :
                     return conditional_H000C5(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PaisCompraNombre",GXType.NChar,60,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000C3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000C5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
