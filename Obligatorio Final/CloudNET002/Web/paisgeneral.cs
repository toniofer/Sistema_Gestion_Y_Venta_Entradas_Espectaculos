   ...
   public class paisgeneral : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A1PaisId,4,0))}, new string[] {"PaisId"}) +"\">") ;
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110g1_client"+"'", TempTags, "", 2, "HLP_PaisGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120g1_client"+"'", TempTags, "", 2, "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, StringUtil.RTrim( A2PaisNombre), StringUtil.RTrim( context.localUtil.Format( A2PaisNombre, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgPaisBandera_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A43PaisBandera_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_PaisGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000PaisBandera_GXI = H000G2_A40000PaisBandera_GXI[0];
               n40000PaisBandera_GXI = H000G2_n40000PaisBandera_GXI[0];
               AssignProp(sPrefix, false, imgPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), true);
               AssignProp(sPrefix, false, imgPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               A2PaisNombre = H000G2_A2PaisNombre[0];
               AssignAttri(sPrefix, false, "A2PaisNombre", A2PaisNombre);
               A43PaisBandera = H000G2_A43PaisBandera[0];
               n43PaisBandera = H000G2_n43PaisBandera[0];
               AssignAttri(sPrefix, false, "A43PaisBandera", A43PaisBandera);
               AssignProp(sPrefix, false, imgPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A43PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A43PaisBandera))), true);
               AssignProp(sPrefix, false, imgPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A43PaisBandera), true);
               /* Execute user event: Load */
               E140G2 ();
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA1PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA1PaisId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            A1PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA1PaisId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A1PaisId", StringUtil.LTrimStr( (decimal)(A1PaisId), 4, 0));
         }
         else
         {
            A1PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A1PaisId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412293", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("paisgeneral.js", "?2023874412293", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E110G1',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120G1',iparms:[{av:'A1PaisId',fld:'PAISID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000G2_A1PaisId = new short[1] ;
         H000G2_A40000PaisBandera_GXI = new string[] {""} ;
         H000G2_n40000PaisBandera_GXI = new bool[] {false} ;
         H000G2_A2PaisNombre = new string[] {""} ;
         H000G2_A43PaisBandera = new string[] {""} ;
         H000G2_n43PaisBandera = new bool[] {false} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisgeneral__default(),
            new Object[][] {
                new Object[] {
               H000G2_A1PaisId, H000G2_A40000PaisBandera_GXI, H000G2_n40000PaisBandera_GXI, H000G2_A2PaisNombre, H000G2_A43PaisBandera, H000G2_n43PaisBandera
               }
            }
         );
         AV13Pgmname = "PaisGeneral";
      ...
      private short[] H000G2_A1PaisId ;
      private string[] H000G2_A40000PaisBandera_GXI ;
      private bool[] H000G2_n40000PaisBandera_GXI ;
      private string[] H000G2_A2PaisNombre ;
      private string[] H000G2_A43PaisBandera ;
      private bool[] H000G2_n43PaisBandera ;
   ...
   public class paisgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "SELECT [PaisId], [PaisBandera_GXI], [PaisNombre], [PaisBandera] FROM [Pais] WHERE [PaisId] = @PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
