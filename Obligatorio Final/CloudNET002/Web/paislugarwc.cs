   ...
   public class paislugarwc : GXWebComponent
   {
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisLugarWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPaisId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9") : context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisId_Visible, edtPaisId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_PaisLugarWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              n44LugarFoto = false;
                              AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A44LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A44LugarFoto))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A44LugarFoto), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LUGARID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A3LugarId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"LUGARID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3LugarId), 4, 0, ".", "")));
      }
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A40000LugarFoto_GXI = H000H2_A40000LugarFoto_GXI[0];
               n40000LugarFoto_GXI = H000H2_n40000LugarFoto_GXI[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A44LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A44LugarFoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A44LugarFoto), true);
               A18LugarDireccion = H000H2_A18LugarDireccion[0];
               A4LugarNombre = H000H2_A4LugarNombre[0];
               A3LugarId = H000H2_A3LugarId[0];
               A44LugarFoto = H000H2_A44LugarFoto[0];
               n44LugarFoto = H000H2_n44LugarFoto[0];
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A44LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A44LugarFoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A44LugarFoto), true);
               E130H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LUGARID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A3LugarId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202387447979", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paislugarwc.js", "?202387447979", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtLugarFoto_Internalname = sPrefix+"LUGARFOTO_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtLugarFoto_Internalname = sPrefix+"LUGARFOTO_"+sGXsfl_22_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130H2',iparms:[{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         A40000LugarFoto_GXI = "";
         scmdbuf = "";
         H000H2_A1PaisId = new short[1] ;
         H000H2_A40000LugarFoto_GXI = new string[] {""} ;
         H000H2_n40000LugarFoto_GXI = new bool[] {false} ;
         H000H2_A18LugarDireccion = new string[] {""} ;
         H000H2_A4LugarNombre = new string[] {""} ;
         H000H2_A3LugarId = new short[1] ;
         H000H2_A44LugarFoto = new string[] {""} ;
         H000H2_n44LugarFoto = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paislugarwc__default(),
            new Object[][] {
                new Object[] {
               H000H2_A1PaisId, H000H2_A40000LugarFoto_GXI, H000H2_n40000LugarFoto_GXI, H000H2_A18LugarDireccion, H000H2_A4LugarNombre, H000H2_A3LugarId, H000H2_A44LugarFoto, H000H2_n44LugarFoto
               }
               , new Object[] {
      ...
      private short[] H000H2_A1PaisId ;
      private string[] H000H2_A40000LugarFoto_GXI ;
      private bool[] H000H2_n40000LugarFoto_GXI ;
      private string[] H000H2_A18LugarDireccion ;
      private string[] H000H2_A4LugarNombre ;
      private short[] H000H2_A3LugarId ;
      private string[] H000H2_A44LugarFoto ;
      private bool[] H000H2_n44LugarFoto ;
   ...
   public class paislugarwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT [PaisId], [LugarFoto_GXI], [LugarDireccion], [LugarNombre], [LugarId], [LugarFoto] FROM [Lugar] WHERE [PaisId] = @AV6PaisId ORDER BY [PaisId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000H3", "SELECT COUNT(*) FROM [Lugar] WHERE [PaisId] = @AV6PaisId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
