...
namespace GeneXus.Programs {
   public class wwpase : GXDataArea
   {
      public wwpase( )
      {
      ...
      public wwpase( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11NombreInvitado = GetPar( "NombreInvitado");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11NombreInvitado, AV12Update, AV13Delete, Gx_date) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpase.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBREINVITADO", StringUtil.RTrim( AV11NombreInvitado));
         /* Send saved values. */
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Pases", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPase.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPase.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavNombreinvitado_Internalname, "Nombre Invitado", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavNombreinvitado_Internalname, StringUtil.RTrim( AV11NombreInvitado), StringUtil.RTrim( context.localUtil.Format( AV11NombreInvitado, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Invitado", edtavNombreinvitado_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavNombreinvitado_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPase.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Pases", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Nombreinvitado Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBREINVITADO"), AV11NombreInvitado) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0D2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavNombreinvitado_Internalname;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A13PaseId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "PASEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A13PaseId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_PASETIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A14PaseTipo, "")), context));
         GxWebStd.gx_hidden_field( context, "PASETIPO", StringUtil.RTrim( A14PaseTipo));
      }
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11NombreInvitado = StringUtil.PadR( StringUtil.RTrim( AV11NombreInvitado), 50, "%");
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {lV11NombreInvitado, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A33EspectaculoInvitacionesEntrega = H000D2_A33EspectaculoInvitacionesEntrega[0];
               A34NombreInvitado = H000D2_A34NombreInvitado[0];
               n34NombreInvitado = H000D2_n34NombreInvitado[0];
               A35PaisCompraPaseNombre = H000D2_A35PaisCompraPaseNombre[0];
               A15PaisCompraPaseId = H000D2_A15PaisCompraPaseId[0];
               n15PaisCompraPaseId = H000D2_n15PaisCompraPaseId[0];
               A23SectorPrecio = H000D2_A23SectorPrecio[0];
               A21SectorNombre = H000D2_A21SectorNombre[0];
               A9SectorId = H000D2_A9SectorId[0];
               n9SectorId = H000D2_n9SectorId[0];
               A19EspectaculoFecha = H000D2_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000D2_A8EspectaculoNombre[0];
               A5EspectaculoId = H000D2_A5EspectaculoId[0];
               A14PaseTipo = H000D2_A14PaseTipo[0];
               A13PaseId = H000D2_A13PaseId[0];
               A35PaisCompraPaseNombre = H000D2_A35PaisCompraPaseNombre[0];
               A33EspectaculoInvitacionesEntrega = H000D2_A33EspectaculoInvitacionesEntrega[0];
               A19EspectaculoFecha = H000D2_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000D2_A8EspectaculoNombre[0];
      ...
      protected void send_integrity_lvl_hashes0D2( )
      {
         GxWebStd.gx_hidden_field( context, "vTODAY", context.localUtil.DToC( Gx_date, 0, "/"));
         GxWebStd.gx_hidden_field( context, "gxhash_vTODAY", GetSecureSignedToken( "", Gx_date, context));
         GxWebStd.gx_hidden_field( context, "gxhash_PASEID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A13PaseId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PASETIPO"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, StringUtil.RTrim( context.localUtil.Format( A14PaseTipo, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11NombreInvitado = StringUtil.PadR( StringUtil.RTrim( AV11NombreInvitado), 50, "%");
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {lV11NombreInvitado});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11NombreInvitado = GridState.FilterValues("Nombreinvitado");
            AssignAttri("", false, "AV11NombreInvitado", AV11NombreInvitado);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("NombreInvitado", AV11NombreInvitado);
      }
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11NombreInvitado = cgiGet( edtavNombreinvitado_Internalname);
            AssignAttri("", false, "AV11NombreInvitado", AV11NombreInvitado);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Pase";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412519", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpase.js", "?2023874412519", false, true);
         }
      ...
      {
         edtPaseId_Internalname = "PASEID_"+sGXsfl_27_idx;
         cmbPaseTipo_Internalname = "PASETIPO_"+sGXsfl_27_idx;
         ...
         edtPaisCompraPaseId_Internalname = "PAISCOMPRAPASEID_"+sGXsfl_27_idx;
         edtPaisCompraPaseNombre_Internalname = "PAISCOMPRAPASENOMBRE_"+sGXsfl_27_idx;
         edtNombreInvitado_Internalname = "NOMBREINVITADO_"+sGXsfl_27_idx;
      ...
      {
         edtPaseId_Internalname = "PASEID_"+sGXsfl_27_fel_idx;
         cmbPaseTipo_Internalname = "PASETIPO_"+sGXsfl_27_fel_idx;
         ...
         edtPaisCompraPaseId_Internalname = "PAISCOMPRAPASEID_"+sGXsfl_27_fel_idx;
         edtPaisCompraPaseNombre_Internalname = "PAISCOMPRAPASENOMBRE_"+sGXsfl_27_fel_idx;
         edtNombreInvitado_Internalname = "NOMBREINVITADO_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "PASETIPO_" + sGXsfl_27_idx;
            ...
            AssignProp("", false, cmbPaseTipo_Internalname, "Values", (string)(cmbPaseTipo.ToJavascriptSource()), !bGXsfl_27_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisCompraPaseId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A15PaisCompraPaseId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A15PaisCompraPaseId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisCompraPaseId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisCompraPaseNombre_Internalname,StringUtil.RTrim( A35PaisCompraPaseNombre),(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaisCompraPaseNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Id País Compra") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "País Compra") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A15PaisCompraPaseId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A35PaisCompraPaseNombre)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavNombreinvitado_Internalname = "vNOMBREINVITADO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavNombreinvitado_Jsonclick = "";
         edtavNombreinvitado_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NombreInvitado',fld:'vNOMBREINVITADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140D2',iparms:[{av:'A19EspectaculoFecha',fld:'ESPECTACULOFECHA',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'A13PaseId',fld:'PASEID',pic:'ZZZ9',hsh:true},{av:'cmbPaseTipo'},{av:'A14PaseTipo',fld:'PASETIPO',pic:'',hsh:true},{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110D2',iparms:[{av:'A13PaseId',fld:'PASEID',pic:'ZZZ9',hsh:true},{av:'cmbPaseTipo'},{av:'A14PaseTipo',fld:'PASETIPO',pic:'',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NombreInvitado',fld:'vNOMBREINVITADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NombreInvitado',fld:'vNOMBREINVITADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NombreInvitado',fld:'vNOMBREINVITADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NombreInvitado',fld:'vNOMBREINVITADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11NombreInvitado = "";
         H000D2_A33EspectaculoInvitacionesEntrega = new short[1] ;
         H000D2_A34NombreInvitado = new string[] {""} ;
         H000D2_n34NombreInvitado = new bool[] {false} ;
         H000D2_A35PaisCompraPaseNombre = new string[] {""} ;
         H000D2_A15PaisCompraPaseId = new short[1] ;
         H000D2_n15PaisCompraPaseId = new bool[] {false} ;
         H000D2_A23SectorPrecio = new int[1] ;
         H000D2_A21SectorNombre = new string[] {""} ;
         H000D2_A9SectorId = new short[1] ;
         H000D2_n9SectorId = new bool[] {false} ;
         H000D2_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000D2_A8EspectaculoNombre = new string[] {""} ;
         H000D2_A5EspectaculoId = new short[1] ;
         H000D2_A14PaseTipo = new string[] {""} ;
         H000D2_A13PaseId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpase__default(),
            new Object[][] {
                new Object[] {
               H000D2_A33EspectaculoInvitacionesEntrega, H000D2_A34NombreInvitado, H000D2_n34NombreInvitado, H000D2_A35PaisCompraPaseNombre, H000D2_A15PaisCompraPaseId, H000D2_n15PaisCompraPaseId, H000D2_A23SectorPrecio, H000D2_A21SectorNombre, H000D2_A9SectorId, H000D2_n9SectorId,
               H000D2_A19EspectaculoFecha, H000D2_A8EspectaculoNombre, H000D2_A5EspectaculoId, H000D2_A14PaseTipo, H000D2_A13PaseId
               }
               , new Object[] {
      ...
      private int edtavNombreinvitado_Enabled ;
      ...
      private string AV11NombreInvitado ;
      ...
      private string edtavNombreinvitado_Internalname ;
      private string edtavNombreinvitado_Jsonclick ;
      ...
      private string lV11NombreInvitado ;
      ...
      private short[] H000D2_A33EspectaculoInvitacionesEntrega ;
      private string[] H000D2_A34NombreInvitado ;
      private bool[] H000D2_n34NombreInvitado ;
      private string[] H000D2_A35PaisCompraPaseNombre ;
      private short[] H000D2_A15PaisCompraPaseId ;
      private bool[] H000D2_n15PaisCompraPaseId ;
      private int[] H000D2_A23SectorPrecio ;
      private string[] H000D2_A21SectorNombre ;
      private short[] H000D2_A9SectorId ;
      private bool[] H000D2_n9SectorId ;
      private DateTime[] H000D2_A19EspectaculoFecha ;
      private string[] H000D2_A8EspectaculoNombre ;
      private short[] H000D2_A5EspectaculoId ;
      private string[] H000D2_A14PaseTipo ;
      private short[] H000D2_A13PaseId ;
   ...
   public class wwpase__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000D2( IGxContext context ,
                                             string AV11NombreInvitado ,
                                             string A34NombreInvitado )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T3.[EspectaculoInvitacionesEntrega], T1.[NombreInvitado], T2.[PaisNombre] AS PaisCompraPaseNombre, T1.[PaisCompraPaseId] AS PaisCompraPaseId, T4.[SectorPrecio], T4.[SectorNombre], T1.[SectorId], T3.[EspectaculoFecha], T3.[EspectaculoNombre], T1.[EspectaculoId], T1.[PaseTipo], T1.[PaseId]";
         sFromString = " FROM ((([Pase] T1 LEFT JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisCompraPaseId]) INNER JOIN [Espectaculo] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId]) LEFT JOIN [EspectaculoSector] T4 ON T4.[EspectaculoId] = T1.[EspectaculoId] AND T4.[SectorId] = T1.[SectorId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NombreInvitado)) )
         {
            AddWhere(sWhereString, "(T1.[NombreInvitado] like @lV11NombreInvitado)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[NombreInvitado]";
                                             ...
                                             string A34NombreInvitado )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([Pase] T1 LEFT JOIN [Pais] T4 ON T4.[PaisId] = T1.[PaisCompraPaseId]) INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) LEFT JOIN [EspectaculoSector] T3 ON T3.[EspectaculoId] = T1.[EspectaculoId] AND T3.[SectorId] = T1.[SectorId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NombreInvitado)) )
         {
            AddWhere(sWhereString, "(T1.[NombreInvitado] like @lV11NombreInvitado)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11NombreInvitado",GXType.NChar,50,0) ,
