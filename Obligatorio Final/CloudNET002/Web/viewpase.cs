...
namespace GeneXus.Programs {
   public class viewpase : GXDataArea
   {
      public viewpase( )
      {
      ...
      public viewpase( IGxContext context )
      {
      ...
      public void execute( short aP0_PaseId ,
                           ...
                           string aP2_TabCode )
      {
         this.AV12PaseId = aP0_PaseId;
         this.AV13PaseTipo = aP1_PaseTipo;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12PaseId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12PaseId", StringUtil.LTrimStr( (decimal)(AV12PaseId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaseId), "ZZZ9"), context));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV13PaseTipo = GetPar( "PaseTipo");
                  AssignAttri("", false, "AV13PaseTipo", AV13PaseTipo);
                  GxWebStd.gx_hidden_field( context, "gxhash_vPASETIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13PaseTipo, "")), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewpase.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12PaseId,4,0)),UrlEncode(StringUtil.RTrim(AV13PaseTipo)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"PaseId","PaseTipo","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPASEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12PaseId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaseId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vPASETIPO", StringUtil.RTrim( AV13PaseTipo));
         GxWebStd.gx_hidden_field( context, "gxhash_vPASETIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13PaseTipo, "")), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewPase");
         forbiddenHiddens.Add("NombreInvitado", StringUtil.RTrim( context.localUtil.Format( A34NombreInvitado, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewpase:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewpase.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12PaseId,4,0)),UrlEncode(StringUtil.RTrim(AV13PaseTipo)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"PaseId","PaseTipo","TabCode"})  ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Pases", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewPase.htm");
            ...
            GxWebStd.gx_label_element( context, edtNombreInvitado_Internalname, "Invitado", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtNombreInvitado_Internalname, StringUtil.RTrim( A34NombreInvitado), StringUtil.RTrim( context.localUtil.Format( A34NombreInvitado, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNombreInvitado_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtNombreInvitado_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewPase.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPase.htm");
            /* Div Control */
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Pase", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0S2( )
      {
         ...
         {
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {AV12PaseId, AV13PaseTipo});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A14PaseTipo = H000S2_A14PaseTipo[0];
               A13PaseId = H000S2_A13PaseId[0];
               A34NombreInvitado = H000S2_A34NombreInvitado[0];
               n34NombreInvitado = H000S2_n34NombreInvitado[0];
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12PaseId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vPASEID"), ",", "."), 18, MidpointRounding.ToEven));
            AV13PaseTipo = cgiGet( "vPASETIPO");
            ...
            {
               GXUtil.WriteLogError("viewpase:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110S2( )
      {
         ...
         AV17GXLvl7 = 0;
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {AV12PaseId, AV13PaseTipo});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A14PaseTipo = H000S3_A14PaseTipo[0];
            A13PaseId = H000S3_A13PaseId[0];
            A34NombreInvitado = H000S3_A34NombreInvitado[0];
            n34NombreInvitado = H000S3_n34NombreInvitado[0];
            AssignAttri("", false, "A34NombreInvitado", A34NombreInvitado);
            AV17GXLvl7 = 1;
            Form.Caption = A34NombreInvitado;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwpase.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "PaseGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "pasegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "PaseGeneral";
               WebComp_Generalwc_Component = "PaseGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12PaseId,(string)AV13PaseTipo});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12PaseId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12PaseId", StringUtil.LTrimStr( (decimal)(AV12PaseId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPASEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaseId), "ZZZ9"), context));
         AV13PaseTipo = (string)getParm(obj,1);
         AssignAttri("", false, "AV13PaseTipo", AV13PaseTipo);
         GxWebStd.gx_hidden_field( context, "gxhash_vPASETIPO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV13PaseTipo, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412551", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpase.js", "?2023874412551", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12PaseId',fld:'vPASEID',pic:'ZZZ9',hsh:true},{av:'AV13PaseTipo',fld:'vPASETIPO',pic:'',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A34NombreInvitado',fld:'NOMBREINVITADO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV16Pgmname = "";
         scmdbuf = "";
         H000S2_A14PaseTipo = new string[] {""} ;
         H000S2_A13PaseId = new short[1] ;
         H000S2_A34NombreInvitado = new string[] {""} ;
         H000S2_n34NombreInvitado = new bool[] {false} ;
         A14PaseTipo = "";
         hsh = "";
         H000S3_A14PaseTipo = new string[] {""} ;
         H000S3_A13PaseId = new short[1] ;
         H000S3_A34NombreInvitado = new string[] {""} ;
         H000S3_n34NombreInvitado = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpase__default(),
            new Object[][] {
                new Object[] {
               H000S2_A14PaseTipo, H000S2_A13PaseId, H000S2_A34NombreInvitado, H000S2_n34NombreInvitado
               }
               , new Object[] {
               H000S3_A14PaseTipo, H000S3_A13PaseId, H000S3_A34NombreInvitado, H000S3_n34NombreInvitado
               }
            }
         );
      ...
      private short AV12PaseId ;
      private short wcpOAV12PaseId ;
      ...
      private int idxLst ;
      private string AV13PaseTipo ;
      private string AV6TabCode ;
      private string wcpOAV13PaseTipo ;
      ...
      private string[] H000S2_A14PaseTipo ;
      private short[] H000S2_A13PaseId ;
      private string[] H000S2_A34NombreInvitado ;
      private bool[] H000S2_n34NombreInvitado ;
      private string[] H000S3_A14PaseTipo ;
      private short[] H000S3_A13PaseId ;
      private string[] H000S3_A34NombreInvitado ;
      private bool[] H000S3_n34NombreInvitado ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewpase__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12PaseId",GXType.Int16,4,0) ,
          new ParDef("@AV13PaseTipo",GXType.NChar,20,0)
          };
          Object[] prmH000S3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [PaseTipo], [PaseId], [NombreInvitado] FROM [Pase] WHERE [PaseId] = @AV12PaseId and [PaseTipo] = @AV13PaseTipo ORDER BY [PaseId], [PaseTipo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000S3", "SELECT [PaseTipo], [PaseId], [NombreInvitado] FROM [Pase] WHERE ([PaseId] = @AV12PaseId and [PaseTipo] = @AV13PaseTipo) AND ([PaseId] = @AV12PaseId and [PaseTipo] = @AV13PaseTipo) ORDER BY [PaseId], [PaseTipo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
