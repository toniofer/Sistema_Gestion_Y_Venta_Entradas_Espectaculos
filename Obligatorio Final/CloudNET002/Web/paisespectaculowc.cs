...
namespace GeneXus.Programs {
   public class paisespectaculowc : GXWebComponent
   {
      ...
      public void execute( short aP0_PaisOrigenId )
      {
         this.AV6PaisOrigenId = aP0_PaisOrigenId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "PaisOrigenId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6PaisOrigenId = (short)(Math.Round(NumberUtil.Val( GetPar( "PaisOrigenId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6PaisOrigenId", StringUtil.LTrimStr( (decimal)(AV6PaisOrigenId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6PaisOrigenId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6PaisOrigenId, AV12Update, AV13Delete, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisespectaculowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PaisOrigenId,4,0))}, new string[] {"PaisOrigenId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6PaisOrigenId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6PaisOrigenId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPAISORIGENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisOrigenId), 4, 0, ",", "")));
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisEspectaculoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_label_element( context, edtPaisOrigenId_Internalname, "Pais Origen Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisOrigenId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A7PaisOrigenId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPaisOrigenId_Enabled!=0) ? context.localUtil.Format( (decimal)(A7PaisOrigenId), "ZZZ9") : context.localUtil.Format( (decimal)(A7PaisOrigenId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisOrigenId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisOrigenId_Visible, edtPaisOrigenId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_PaisEspectaculoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000I2 */
            pr_default.execute(0, new Object[] {AV6PaisOrigenId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A7PaisOrigenId = H000I2_A7PaisOrigenId[0];
               AssignAttri(sPrefix, false, "A7PaisOrigenId", StringUtil.LTrimStr( (decimal)(A7PaisOrigenId), 4, 0));
               A36CantidadProductos = H000I2_A36CantidadProductos[0];
               A29CantidadSectores = H000I2_A29CantidadSectores[0];
               A40000EspectaculoAfiche_GXI = H000I2_A40000EspectaculoAfiche_GXI[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A2PaisNombre = H000I2_A2PaisNombre[0];
               A4LugarNombre = H000I2_A4LugarNombre[0];
               A3LugarId = H000I2_A3LugarId[0];
               A16TipoEspectaculoNombre = H000I2_A16TipoEspectaculoNombre[0];
               A6TipoEspectaculoId = H000I2_A6TipoEspectaculoId[0];
               A19EspectaculoFecha = H000I2_A19EspectaculoFecha[0];
               A8EspectaculoNombre = H000I2_A8EspectaculoNombre[0];
               A5EspectaculoId = H000I2_A5EspectaculoId[0];
               A33EspectaculoInvitacionesEntrega = H000I2_A33EspectaculoInvitacionesEntrega[0];
               A31EspectaculoCantidadInvitacione = H000I2_A31EspectaculoCantidadInvitacione[0];
               A20EspectaculoAfiche = H000I2_A20EspectaculoAfiche[0];
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A20EspectaculoAfiche)) ? A40000EspectaculoAfiche_GXI : context.convertURL( context.PathToRelativeUrl( A20EspectaculoAfiche))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtEspectaculoAfiche_Internalname, "SrcSet", context.GetImageSrcSet( A20EspectaculoAfiche), true);
               A1PaisId = H000I2_A1PaisId[0];
               A4LugarNombre = H000I2_A4LugarNombre[0];
      ...
      {
         /* Using cursor H000I3 */
         pr_default.execute(1, new Object[] {AV6PaisOrigenId});
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PaisOrigenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisOrigenId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E120I2( )
      {
         ...
         AV13Delete = "Eliminar";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtPaisOrigenId_Visible = 0;
         AssignProp(sPrefix, false, edtPaisOrigenId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtPaisOrigenId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "PaisOrigenId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6PaisOrigenId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6PaisOrigenId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6PaisOrigenId", StringUtil.LTrimStr( (decimal)(AV6PaisOrigenId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6PaisOrigenId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV6PaisOrigenId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6PaisOrigenId", StringUtil.LTrimStr( (decimal)(AV6PaisOrigenId), 4, 0));
         }
         wcpOAV6PaisOrigenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisOrigenId"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV6PaisOrigenId != wcpOAV6PaisOrigenId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6PaisOrigenId = AV6PaisOrigenId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6PaisOrigenId = cgiGet( sPrefix+"AV6PaisOrigenId_CTRL");
         if ( StringUtil.Len( sCtrlAV6PaisOrigenId) > 0 )
         {
            AV6PaisOrigenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6PaisOrigenId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6PaisOrigenId", StringUtil.LTrimStr( (decimal)(AV6PaisOrigenId), 4, 0));
         }
         else
         {
            AV6PaisOrigenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6PaisOrigenId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6PaisOrigenId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisOrigenId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6PaisOrigenId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6PaisOrigenId_CTRL", StringUtil.RTrim( sCtrlAV6PaisOrigenId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412381", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paisespectaculowc.js", "?2023874412382", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisOrigenId',fld:'vPAISORIGENID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130I2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9'},{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110I2',iparms:[{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisOrigenId',fld:'vPAISORIGENID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisOrigenId',fld:'vPAISORIGENID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisOrigenId',fld:'vPAISORIGENID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PaisOrigenId',fld:'vPAISORIGENID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000I2_A1PaisId = new short[1] ;
         H000I2_A7PaisOrigenId = new short[1] ;
         H000I2_A36CantidadProductos = new short[1] ;
         H000I2_A29CantidadSectores = new short[1] ;
         H000I2_A40000EspectaculoAfiche_GXI = new string[] {""} ;
         H000I2_A2PaisNombre = new string[] {""} ;
         H000I2_A4LugarNombre = new string[] {""} ;
         H000I2_A3LugarId = new short[1] ;
         H000I2_A16TipoEspectaculoNombre = new string[] {""} ;
         H000I2_A6TipoEspectaculoId = new short[1] ;
         H000I2_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000I2_A8EspectaculoNombre = new string[] {""} ;
         H000I2_A5EspectaculoId = new short[1] ;
         H000I2_A33EspectaculoInvitacionesEntrega = new short[1] ;
         H000I2_A31EspectaculoCantidadInvitacione = new short[1] ;
         H000I2_A20EspectaculoAfiche = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisespectaculowc__default(),
            new Object[][] {
                new Object[] {
               H000I2_A1PaisId, H000I2_A7PaisOrigenId, H000I2_A36CantidadProductos, H000I2_A29CantidadSectores, H000I2_A40000EspectaculoAfiche_GXI, H000I2_A2PaisNombre, H000I2_A4LugarNombre, H000I2_A3LugarId, H000I2_A16TipoEspectaculoNombre, H000I2_A6TipoEspectaculoId,
               H000I2_A19EspectaculoFecha, H000I2_A8EspectaculoNombre, H000I2_A5EspectaculoId, H000I2_A33EspectaculoInvitacionesEntrega, H000I2_A31EspectaculoCantidadInvitacione, H000I2_A20EspectaculoAfiche
               }
               , new Object[] {
      ...
      private short AV6PaisOrigenId ;
      private short wcpOAV6PaisOrigenId ;
      ...
      private int edtPaisOrigenId_Visible ;
      ...
      private string sCtrlAV6PaisOrigenId ;
      ...
      private short[] H000I2_A1PaisId ;
      private short[] H000I2_A7PaisOrigenId ;
      private short[] H000I2_A36CantidadProductos ;
      private short[] H000I2_A29CantidadSectores ;
      private string[] H000I2_A40000EspectaculoAfiche_GXI ;
      private string[] H000I2_A2PaisNombre ;
      private string[] H000I2_A4LugarNombre ;
      private short[] H000I2_A3LugarId ;
      private string[] H000I2_A16TipoEspectaculoNombre ;
      private short[] H000I2_A6TipoEspectaculoId ;
      private DateTime[] H000I2_A19EspectaculoFecha ;
      private string[] H000I2_A8EspectaculoNombre ;
      private short[] H000I2_A5EspectaculoId ;
      private short[] H000I2_A33EspectaculoInvitacionesEntrega ;
      private short[] H000I2_A31EspectaculoCantidadInvitacione ;
      private string[] H000I2_A20EspectaculoAfiche ;
   ...
   public class paisespectaculowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6PaisOrigenId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT T2.[PaisId], T1.[PaisOrigenId], T1.[CantidadProductos], T1.[CantidadSectores], T1.[EspectaculoAfiche_GXI], T3.[PaisNombre], T2.[LugarNombre], T1.[LugarId], T4.[TipoEspectaculoNombre], T1.[TipoEspectaculoId], T1.[EspectaculoFecha], T1.[EspectaculoNombre], T1.[EspectaculoId], T1.[EspectaculoInvitacionesEntrega], T1.[EspectaculoCantidadInvitacione], T1.[EspectaculoAfiche] FROM ((([Espectaculo] T1 INNER JOIN [Lugar] T2 ON T2.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T3 ON T3.[PaisId] = T2.[PaisId]) INNER JOIN [TipoEspectaculo] T4 ON T4.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[PaisOrigenId] = @AV6PaisOrigenId ORDER BY T1.[PaisOrigenId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000I3", "SELECT COUNT(*) FROM ((([Espectaculo] T1 INNER JOIN [Lugar] T3 ON T3.[LugarId] = T1.[LugarId]) INNER JOIN [Pais] T4 ON T4.[PaisId] = T3.[PaisId]) INNER JOIN [TipoEspectaculo] T2 ON T2.[TipoEspectaculoId] = T1.[TipoEspectaculoId]) WHERE T1.[PaisOrigenId] = @AV6PaisOrigenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
