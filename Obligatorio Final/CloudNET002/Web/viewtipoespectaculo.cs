...
namespace GeneXus.Programs {
   public class viewtipoespectaculo : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("TipoEspectaculoNombre", StringUtil.RTrim( context.localUtil.Format( A16TipoEspectaculoNombre, "")));
      ...
      protected void WB070( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Tipos de Espectáculo", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            ...
            GxWebStd.gx_label_element( context, edtTipoEspectaculoNombre_Internalname, "Espectáculo Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTipoEspectaculoNombre_Internalname, StringUtil.RTrim( A16TipoEspectaculoNombre), StringUtil.RTrim( context.localUtil.Format( A16TipoEspectaculoNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTipoEspectaculoNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtTipoEspectaculoNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEspectaculo_title_Internalname, "Espectáculo", "", "", lblEspectaculo_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewTipoEspectaculo.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void RF072( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A6TipoEspectaculoId = H00072_A6TipoEspectaculoId[0];
               A16TipoEspectaculoNombre = H00072_A16TipoEspectaculoNombre[0];
      ...
      protected void E11072( )
      {
         ...
         {
            A6TipoEspectaculoId = H00073_A6TipoEspectaculoId[0];
            A16TipoEspectaculoNombre = H00073_A16TipoEspectaculoNombre[0];
            AssignAttri("", false, "A16TipoEspectaculoNombre", A16TipoEspectaculoNombre);
            AV16GXLvl7 = 1;
            Form.Caption = A16TipoEspectaculoNombre;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412439", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtipoespectaculo.js", "?2023874412439", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12TipoEspectaculoId',fld:'vTIPOESPECTACULOID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A16TipoEspectaculoNombre',fld:'TIPOESPECTACULONOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00072_A6TipoEspectaculoId = new short[1] ;
         H00072_A16TipoEspectaculoNombre = new string[] {""} ;
         hsh = "";
         H00073_A6TipoEspectaculoId = new short[1] ;
         H00073_A16TipoEspectaculoNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H00072_A6TipoEspectaculoId, H00072_A16TipoEspectaculoNombre
               }
               , new Object[] {
               H00073_A6TipoEspectaculoId, H00073_A16TipoEspectaculoNombre
               }
            }
         );
      ...
      private short[] H00072_A6TipoEspectaculoId ;
      private string[] H00072_A16TipoEspectaculoNombre ;
      private short[] H00073_A6TipoEspectaculoId ;
      private string[] H00073_A16TipoEspectaculoNombre ;
   ...
   public class viewtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00072", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00072,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00073", "SELECT [TipoEspectaculoId], [TipoEspectaculoNombre] FROM [TipoEspectaculo] WHERE [TipoEspectaculoId] = @AV12TipoEspectaculoId ORDER BY [TipoEspectaculoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00073,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
