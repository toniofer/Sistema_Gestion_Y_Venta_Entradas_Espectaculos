   ...
   public class lugargeneral : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A3LugarId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("lugargeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A3LugarId,4,0))}, new string[] {"LugarId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA3LugarId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA3LugarId), 4, 0, ",", "")));
      }
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Modificar", bttBtnupdate_Jsonclick, 7, "Modificar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110o1_client"+"'", TempTags, "", 2, "HLP_LugarGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120o1_client"+"'", TempTags, "", 2, "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLugarNombre_Internalname, StringUtil.RTrim( A4LugarNombre), StringUtil.RTrim( context.localUtil.Format( A4LugarNombre, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLugarNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtLugarNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPaisId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9") : context.localUtil.Format( (decimal)(A1PaisId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, StringUtil.RTrim( A2PaisNombre), StringUtil.RTrim( context.localUtil.Format( A2PaisNombre, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgLugarFoto_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, A44LugarFoto_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_LugarGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000LugarFoto_GXI = H000O2_A40000LugarFoto_GXI[0];
               n40000LugarFoto_GXI = H000O2_n40000LugarFoto_GXI[0];
               AssignProp(sPrefix, false, imgLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A44LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A44LugarFoto))), true);
               AssignProp(sPrefix, false, imgLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A44LugarFoto), true);
               A18LugarDireccion = H000O2_A18LugarDireccion[0];
               AssignAttri(sPrefix, false, "A18LugarDireccion", A18LugarDireccion);
               A2PaisNombre = H000O2_A2PaisNombre[0];
               AssignAttri(sPrefix, false, "A2PaisNombre", A2PaisNombre);
               A1PaisId = H000O2_A1PaisId[0];
               AssignAttri(sPrefix, false, "A1PaisId", StringUtil.LTrimStr( (decimal)(A1PaisId), 4, 0));
               A4LugarNombre = H000O2_A4LugarNombre[0];
               AssignAttri(sPrefix, false, "A4LugarNombre", A4LugarNombre);
               A44LugarFoto = H000O2_A44LugarFoto[0];
               n44LugarFoto = H000O2_n44LugarFoto[0];
               AssignAttri(sPrefix, false, "A44LugarFoto", A44LugarFoto);
               AssignProp(sPrefix, false, imgLugarFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A44LugarFoto)) ? A40000LugarFoto_GXI : context.convertURL( context.PathToRelativeUrl( A44LugarFoto))), true);
               AssignProp(sPrefix, false, imgLugarFoto_Internalname, "SrcSet", context.GetImageSrcSet( A44LugarFoto), true);
               A2PaisNombre = H000O2_A2PaisNombre[0];
               AssignAttri(sPrefix, false, "A2PaisNombre", A2PaisNombre);
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA3LugarId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA3LugarId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A3LugarId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A3LugarId", StringUtil.LTrimStr( (decimal)(A3LugarId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA3LugarId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A3LugarId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A3LugarId", StringUtil.LTrimStr( (decimal)(A3LugarId), 4, 0));
         }
         wcpOA3LugarId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA3LugarId"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A3LugarId != wcpOA3LugarId ) ) )
         {
            setjustcreated();
         }
         wcpOA3LugarId = A3LugarId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA3LugarId = cgiGet( sPrefix+"A3LugarId_CTRL");
         if ( StringUtil.Len( sCtrlA3LugarId) > 0 )
         {
            A3LugarId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA3LugarId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A3LugarId", StringUtil.LTrimStr( (decimal)(A3LugarId), 4, 0));
         }
         else
         {
            A3LugarId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A3LugarId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A3LugarId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3LugarId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA3LugarId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A3LugarId_CTRL", StringUtil.RTrim( sCtrlA3LugarId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202387447830", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("lugargeneral.js", "?202387447830", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E110O1',iparms:[{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120O1',iparms:[{av:'A3LugarId',fld:'LUGARID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000O2_A3LugarId = new short[1] ;
         H000O2_A40000LugarFoto_GXI = new string[] {""} ;
         H000O2_n40000LugarFoto_GXI = new bool[] {false} ;
         H000O2_A18LugarDireccion = new string[] {""} ;
         H000O2_A2PaisNombre = new string[] {""} ;
         H000O2_A1PaisId = new short[1] ;
         H000O2_A4LugarNombre = new string[] {""} ;
         H000O2_A44LugarFoto = new string[] {""} ;
         H000O2_n44LugarFoto = new bool[] {false} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.lugargeneral__default(),
            new Object[][] {
                new Object[] {
               H000O2_A3LugarId, H000O2_A40000LugarFoto_GXI, H000O2_n40000LugarFoto_GXI, H000O2_A18LugarDireccion, H000O2_A2PaisNombre, H000O2_A1PaisId, H000O2_A4LugarNombre, H000O2_A44LugarFoto, H000O2_n44LugarFoto
               }
            }
         );
         AV13Pgmname = "LugarGeneral";
      ...
      private short[] H000O2_A3LugarId ;
      private string[] H000O2_A40000LugarFoto_GXI ;
      private bool[] H000O2_n40000LugarFoto_GXI ;
      private string[] H000O2_A18LugarDireccion ;
      private string[] H000O2_A2PaisNombre ;
      private short[] H000O2_A1PaisId ;
      private string[] H000O2_A4LugarNombre ;
      private string[] H000O2_A44LugarFoto ;
      private bool[] H000O2_n44LugarFoto ;
   ...
   public class lugargeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000O2", "SELECT T1.[LugarId], T1.[LugarFoto_GXI], T1.[LugarDireccion], T2.[PaisNombre], T1.[PaisId], T1.[LugarNombre], T1.[LugarFoto] FROM ([Lugar] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) WHERE T1.[LugarId] = @LugarId ORDER BY T1.[LugarId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
