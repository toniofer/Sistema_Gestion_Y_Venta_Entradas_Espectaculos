...
namespace GeneXus.Programs {
   public class wwtipoespectaculo : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTIPOESPECTACULONOMBRE", StringUtil.RTrim( AV11TipoEspectaculoNombre));
         /* Send saved values. */
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Tipos de Espectáculo", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWTipoEspectaculo.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lbllbl15_Internalname, "", "", "", lbllbl15_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "navbar-brand", 0, "", 1, 1, 0, 0, "HLP_WWTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(30), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWTipoEspectaculo.htm");
            context.WriteHtmlText( "</li>") ;
            context.WriteHtmlText( "<li>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'',0)\"";
            ClassString = "Button button-tertiary";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnespectaculosportipo_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(30), 2, 0)+","+"null"+");", "Listado Espectáculos por Tipo", bttBtnespectaculosportipo_Jsonclick, 7, "Lista todos los espectáculos agrupados por tipo", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110e1_client"+"'", TempTags, "", 2, "HLP_WWTipoEspectaculo.htm");
            context.WriteHtmlText( "</li>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipoespectaculonombre_Internalname, StringUtil.RTrim( AV11TipoEspectaculoNombre), StringUtil.RTrim( context.localUtil.Format( AV11TipoEspectaculoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Espectaculo Nombre", edtavTipoespectaculonombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavTipoespectaculonombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWTipoEspectaculo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11TipoEspectaculoNombre = StringUtil.PadR( StringUtil.RTrim( AV11TipoEspectaculoNombre), 60, "%");
            /* Using cursor H000E2 */
            ...
            {
               A16TipoEspectaculoNombre = H000E2_A16TipoEspectaculoNombre[0];
               A6TipoEspectaculoId = H000E2_A6TipoEspectaculoId[0];
               E150E2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPOESPECTACULOID"+"_"+sGXsfl_30_idx, GetSecureSignedToken( sGXsfl_30_idx, context.localUtil.Format( (decimal)(A6TipoEspectaculoId), "ZZZ9"), context));
      }
      ...
      private void E150E2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A6TipoEspectaculoId,4,0))}, new string[] {"Mode","TipoEspectaculoId"}) ;
         edtavDelete_Link = formatLink("tipoespectaculo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A6TipoEspectaculoId,4,0))}, new string[] {"Mode","TipoEspectaculoId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412487", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtipoespectaculo.js", "?2023874412487", false, true);
         }
      ...
      {
         edtTipoEspectaculoId_Internalname = "TIPOESPECTACULOID_"+sGXsfl_30_idx;
         edtTipoEspectaculoNombre_Internalname = "TIPOESPECTACULONOMBRE_"+sGXsfl_30_idx;
      ...
      {
         edtTipoEspectaculoId_Internalname = "TIPOESPECTACULOID_"+sGXsfl_30_fel_idx;
         edtTipoEspectaculoNombre_Internalname = "TIPOESPECTACULONOMBRE_"+sGXsfl_30_fel_idx;
      ...
      protected void StartGridControl30( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Tipo de espectáculo") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      protected void init_default_properties( )
      {
         ...
         bttBtnespectaculosportipo_Internalname = "BTNESPECTACULOSPORTIPO";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E150E2',iparms:[{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E120E2',iparms:[{av:'A6TipoEspectaculoId',fld:'TIPOESPECTACULOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("'DOESPECTACULOSPORTIPO'","{handler:'E110E1',iparms:[]");
         setEventMetadata("'DOESPECTACULOSPORTIPO'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11TipoEspectaculoNombre',fld:'vTIPOESPECTACULONOMBRE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         bttBtnespectaculosportipo_Jsonclick = "";
         GridContainer = new GXWebGrid( context);
         sStyleString = "";
         sEvt = "";
         EvtGridId = "";
         ...
         H000E2_A16TipoEspectaculoNombre = new string[] {""} ;
         H000E2_A6TipoEspectaculoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtipoespectaculo__default(),
            new Object[][] {
                new Object[] {
               H000E2_A16TipoEspectaculoNombre, H000E2_A6TipoEspectaculoId
               }
               , new Object[] {
      ...
      private string bttBtnespectaculosportipo_Internalname ;
      private string bttBtnespectaculosportipo_Jsonclick ;
      ...
      private string[] H000E2_A16TipoEspectaculoNombre ;
      private short[] H000E2_A6TipoEspectaculoId ;
   ...
   public class wwtipoespectaculo__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000E2( IGxContext context ,
                                             string AV11TipoEspectaculoNombre ,
                                             string A16TipoEspectaculoNombre )
      {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11TipoEspectaculoNombre",GXType.NChar,60,0) ,
