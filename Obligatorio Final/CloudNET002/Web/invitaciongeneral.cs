   ...
   public class invitaciongeneral : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A17InvitacionId", StringUtil.LTrimStr( (decimal)(A17InvitacionId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A17InvitacionId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("invitaciongeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A17InvitacionId,4,0))}, new string[] {"InvitacionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA17InvitacionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA17InvitacionId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESPECTACULOCANTIDADINVITACIONE", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31EspectaculoCantidadInvitacione), 4, 0, ",", "")));
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Eliminar", bttBtndelete_Jsonclick, 7, "Eliminar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110q1_client"+"'", TempTags, "", 2, "HLP_InvitacionGeneral.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtInvitacionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A17InvitacionId), 4, 0, ",", "")), StringUtil.LTrim( ((edtInvitacionId_Enabled!=0) ? context.localUtil.Format( (decimal)(A17InvitacionId), "ZZZ9") : context.localUtil.Format( (decimal)(A17InvitacionId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvitacionId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtInvitacionId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_InvitacionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtInvitacionNombreInvitado_Internalname, "Nombre Invitado", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtInvitacionNombreInvitado_Internalname, StringUtil.RTrim( A30InvitacionNombreInvitado), StringUtil.RTrim( context.localUtil.Format( A30InvitacionNombreInvitado, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvitacionNombreInvitado_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtInvitacionNombreInvitado_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_InvitacionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEspectaculoId_Internalname, "Espectáculo Id", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEspectaculoNombre_Internalname, "Espectáculo Nombre", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEspectaculoNombre_Internalname, StringUtil.RTrim( A8EspectaculoNombre), StringUtil.RTrim( context.localUtil.Format( A8EspectaculoNombre, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtEspectaculoNombre_Link, "", "", "", edtEspectaculoNombre_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEspectaculoNombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_InvitacionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtEspectaculoFecha_Internalname, "Espectáculo Fecha", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtEspectaculoFecha_Internalname, context.localUtil.Format(A19EspectaculoFecha, "99/99/99"), context.localUtil.Format( A19EspectaculoFecha, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEspectaculoFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEspectaculoFecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_InvitacionGeneral.htm");
            GxWebStd.gx_bitmap( context, edtEspectaculoFecha_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtEspectaculoFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_InvitacionGeneral.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEspectaculoInvitacionesEntrega_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A33EspectaculoInvitacionesEntrega), 4, 0, ",", "")), StringUtil.LTrim( ((edtEspectaculoInvitacionesEntrega_Enabled!=0) ? context.localUtil.Format( (decimal)(A33EspectaculoInvitacionesEntrega), "ZZZ9") : context.localUtil.Format( (decimal)(A33EspectaculoInvitacionesEntrega), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEspectaculoInvitacionesEntrega_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtEspectaculoInvitacionesEntrega_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_InvitacionGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19EspectaculoFecha = H000Q2_A19EspectaculoFecha[0];
               AssignAttri(sPrefix, false, "A19EspectaculoFecha", context.localUtil.Format(A19EspectaculoFecha, "99/99/99"));
               A8EspectaculoNombre = H000Q2_A8EspectaculoNombre[0];
               AssignAttri(sPrefix, false, "A8EspectaculoNombre", A8EspectaculoNombre);
               A5EspectaculoId = H000Q2_A5EspectaculoId[0];
               AssignAttri(sPrefix, false, "A5EspectaculoId", StringUtil.LTrimStr( (decimal)(A5EspectaculoId), 4, 0));
               A30InvitacionNombreInvitado = H000Q2_A30InvitacionNombreInvitado[0];
               AssignAttri(sPrefix, false, "A30InvitacionNombreInvitado", A30InvitacionNombreInvitado);
               A33EspectaculoInvitacionesEntrega = H000Q2_A33EspectaculoInvitacionesEntrega[0];
               ...
               A31EspectaculoCantidadInvitacione = H000Q2_A31EspectaculoCantidadInvitacione[0];
               A19EspectaculoFecha = H000Q2_A19EspectaculoFecha[0];
               AssignAttri(sPrefix, false, "A19EspectaculoFecha", context.localUtil.Format(A19EspectaculoFecha, "99/99/99"));
               A8EspectaculoNombre = H000Q2_A8EspectaculoNombre[0];
               AssignAttri(sPrefix, false, "A8EspectaculoNombre", A8EspectaculoNombre);
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA17InvitacionId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17InvitacionId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A17InvitacionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A17InvitacionId", StringUtil.LTrimStr( (decimal)(A17InvitacionId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA17InvitacionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A17InvitacionId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A17InvitacionId", StringUtil.LTrimStr( (decimal)(A17InvitacionId), 4, 0));
         }
         wcpOA17InvitacionId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17InvitacionId"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A17InvitacionId != wcpOA17InvitacionId ) ) )
         {
            setjustcreated();
         }
         wcpOA17InvitacionId = A17InvitacionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA17InvitacionId = cgiGet( sPrefix+"A17InvitacionId_CTRL");
         if ( StringUtil.Len( sCtrlA17InvitacionId) > 0 )
         {
            A17InvitacionId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA17InvitacionId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A17InvitacionId", StringUtil.LTrimStr( (decimal)(A17InvitacionId), 4, 0));
         }
         else
         {
            A17InvitacionId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A17InvitacionId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A17InvitacionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A17InvitacionId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA17InvitacionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A17InvitacionId_CTRL", StringUtil.RTrim( sCtrlA17InvitacionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023874412395", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("invitaciongeneral.js", "?2023874412395", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A17InvitacionId',fld:'INVITACIONID',pic:'ZZZ9'},{av:'A5EspectaculoId',fld:'ESPECTACULOID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E110Q1',iparms:[{av:'A17InvitacionId',fld:'INVITACIONID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000Q2_A17InvitacionId = new short[1] ;
         H000Q2_A19EspectaculoFecha = new DateTime[] {DateTime.MinValue} ;
         H000Q2_A8EspectaculoNombre = new string[] {""} ;
         H000Q2_A5EspectaculoId = new short[1] ;
         H000Q2_A30InvitacionNombreInvitado = new string[] {""} ;
         H000Q2_A33EspectaculoInvitacionesEntrega = new short[1] ;
         H000Q2_A31EspectaculoCantidadInvitacione = new short[1] ;
         hsh = "";
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         sCtrlA17InvitacionId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.invitaciongeneral__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A17InvitacionId, H000Q2_A19EspectaculoFecha, H000Q2_A8EspectaculoNombre, H000Q2_A5EspectaculoId, H000Q2_A30InvitacionNombreInvitado, H000Q2_A33EspectaculoInvitacionesEntrega, H000Q2_A31EspectaculoCantidadInvitacione
               }
            }
         );
         AV13Pgmname = "InvitacionGeneral";
      ...
      private short wcpOA17InvitacionId ;
      ...
      private string hsh ;
      private string sCtrlA17InvitacionId ;
      ...
      private short[] H000Q2_A17InvitacionId ;
      private DateTime[] H000Q2_A19EspectaculoFecha ;
      private string[] H000Q2_A8EspectaculoNombre ;
      private short[] H000Q2_A5EspectaculoId ;
      private string[] H000Q2_A30InvitacionNombreInvitado ;
      private short[] H000Q2_A33EspectaculoInvitacionesEntrega ;
      private short[] H000Q2_A31EspectaculoCantidadInvitacione ;
   ...
   public class invitaciongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT T1.[InvitacionId], T2.[EspectaculoFecha], T2.[EspectaculoNombre], T1.[EspectaculoId], T1.[InvitacionNombreInvitado], T2.[EspectaculoInvitacionesEntrega], T2.[EspectaculoCantidadInvitacione] FROM ([Invitacion] T1 INNER JOIN [Espectaculo] T2 ON T2.[EspectaculoId] = T1.[EspectaculoId]) WHERE T1.[InvitacionId] = @InvitacionId ORDER BY T1.[InvitacionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
